...
// CODE HERE...
String.grammarPolice = function(str){
  var loweredArray = str.toLowerCase().split(" ");
  for(var i = 0; i < loweredArray.length; i++){
    loweredArray[i][0].toUpperCase()
  }
  return loweredArray.join(" ");
}
...
// CODE HERE...
var promiseCatcher = function(promise){
